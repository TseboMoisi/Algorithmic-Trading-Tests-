...
# strings in this list represent the columns of the DataFrame that we will
# fill with historical market data
TRADE_BAR_PROPERTIES = {"time", "open", "high", "low", "close", "volume"}

# Sends requests to the IB API
class IBClient(EClient):
    ...
    # a function that allows users to request data for multiple contracts
